...
interface RefrescoDao {
    ...
    @Query("SELECT * FROM refrescos WHERE id = :id")
    suspend fun getById(id: Long): RefrescoEntity?

    @Query("DELETE FROM refrescos")
    ...
    fun getAllRefrescos(): Flow<List<RefrescoEntity>>
