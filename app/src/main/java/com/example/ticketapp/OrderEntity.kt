...
/**
 * Entidad que representa una orden (una venta o ticket completo). Guarda la información general de
 * la transacción.
 */
...
data class OrderEntity(
        ...
        @ColumnInfo(name = "daily_order_number") val dailyOrderNumber: Int? = null
)
